...
void ALampPostQueryLayer::AddAdditionalMaterial(const ALampPostItem* Item, UMaterialInstance* Material)
{
	if (!Material)
	{
		return;
...
void ALampPostQueryLayer::RefreshProperties(ALampPostItem* Item)
{
...
void ALampPostQueryLayer::SelectFeature()
{
	if (APlayerController* PlayerController = Cast<APlayerController>(GetWorld()->GetFirstPlayerController()))
	{
		                                          ...
		                                          EDrawDebugTrace::None, HitResult, true))
		{
			...
			currentFeature = Cast<ALampPostItem>(HitResult.GetActor());
...
void ALampPostQueryLayer::SpawnFeatures(int Start, int Last)
{
